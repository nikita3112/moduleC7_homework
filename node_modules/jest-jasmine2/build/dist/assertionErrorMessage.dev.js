...
var assertThrowingMatcherHint = function assertThrowingMatcherHint(operatorName) {
  return operatorName ? _chalk["default"].dim('assert') + _chalk["default"].dim('.' + operatorName + '(') + _chalk["default"].red('function') + _chalk["default"].dim(')') : '';
};
...
function assertionErrorMessage(error, options) {
  ...
  return buildHintString(assertMatcherHint(operator, operatorName, expected)) + _chalk["default"].reset("Expected value ".concat(operatorMessage(operator))) + "  ".concat((0, _jestMatcherUtils.printExpected)(expected), "\n") + _chalk["default"].reset("Received:\n") + "  ".concat((0, _jestMatcherUtils.printReceived)(actual)) + _chalk["default"].reset(hasCustomMessage ? '\n\nMessage:\n  ' + message : '') + (diffString ? "\n\nDifference:\n\n".concat(diffString) : '') + trimmedStack;
}
