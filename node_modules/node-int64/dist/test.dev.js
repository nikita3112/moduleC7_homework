...
exports.testBufferToString = function (test) {
  var _int = new Int64(0xfffaffff, 0xfffff700);

  test.equal(_int.toBuffer().toString('hex'), 'fffafffffffff700', 'Buffer to string conversion');
  test.done();
};
...
exports.testBufferOffsets = function (test) {
  ...
  var _int2 = new Int64(sourceBuffer, 2);

  assert.equal(_int2.toBuffer().toString('hex'), 'fffafffffffff700', 'Construct from offset');
  var targetBuffer = new Buffer(16);

  _int2.copy(targetBuffer, 4);
