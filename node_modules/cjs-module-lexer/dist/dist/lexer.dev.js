...
exports.parse = parse;
exports.init = init;
var A = new Set(["implements", "interface", "let", "package", "private", "protected", "public", "static", "yield", "enum"]);
var Q;
var B = 1 === new Uint8Array(new Uint16Array([1]).buffer)[0];

function parse(g) {
  var I = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "@";
  if (!Q) throw new Error("Not initialized");
  var D = g.length + 1,
      N = (Q.__heap_base.value || Q.__heap_base) + 4 * D - Q.memory.buffer.byteLength;
  N > 0 && Q.memory.grow(Math.ceil(N / 65536));
  var k = Q.sa(D);
  if ((B ? C : E)(g, new Uint16Array(Q.memory.buffer, k, D)), !Q.parseCJS(k, g.length, 0, 0)) throw Object.assign(new Error("Parse error ".concat(I).concat(Q.e(), ":").concat(g.slice(0, Q.e()).split("\n").length, ":").concat(Q.e() - g.lastIndexOf("\n", Q.e() - 1))), {
    idx: Q.e()
  });
  var w = new Set(),
      o = new Set();
  ...
  for (; Q.rre();) {
    o.add(g.slice(Q.res(), Q.ree()));
  }

  for (; Q.re();) {
    var _B = g.slice(Q.es(), Q.ee());
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            A = _context.sent;
            _context.next = 5;
            return regeneratorRuntime.awrap(WebAssembly.instantiate(A));
