...
var _require = require('./CSSStyleDeclaration'),
...
var dashedProperties = [].concat(_toConsumableArray(allProperties), _toConsumableArray(allExtraProperties));
...
var invalidProperties = implementedProperties.filter(function (prop) {
  return !allowedProperties.includes(prop);
});
describe('CSSStyleDeclaration', function () {
  test('has only valid properties implemented', function () {
  ...
  test('has dashed properties', function () {
    var style = new CSSStyleDeclaration();
  ...
  test('has all functions', function () {
    var style = new CSSStyleDeclaration();
    expect(_typeof(style.item)).toEqual('function');
    expect(_typeof(style.getPropertyValue)).toEqual('function');
    expect(_typeof(style.setProperty)).toEqual('function');
    expect(_typeof(style.getPropertyPriority)).toEqual('function');
    expect(_typeof(style.removeProperty)).toEqual('function'); // TODO - deprecated according to MDN and not implemented at all, can we remove?

    expect(_typeof(style.getPropertyCSSValue)).toEqual('function');
  });
  test('has special properties', function () {
    var style = new CSSStyleDeclaration();
  ...
  test('from style string', function () {
    var style = new CSSStyleDeclaration();
  ...
  test('width and height properties and null and empty strings', function () {
    var style = new CSSStyleDeclaration();
    style.height = 6;
  ...
  test('top, left, right, bottom properties', function () {
    var style = new CSSStyleDeclaration();
    style.top = 0;
    style.left = '0%';
    style.right = '5em';
  ...
  test('clear and clip properties', function () {
    var style = new CSSStyleDeclaration();
    style.clear = 'none';
  ...
  test('short hand properties with embedded spaces', function () {
    var style = new CSSStyleDeclaration();
  ...
  test('setting shorthand properties to an empty string should clear all dependent properties', function () {
    var style = new CSSStyleDeclaration();
  ...
  test('setting implicit properties to an empty string should clear all dependent properties', function () {
    var style = new CSSStyleDeclaration();
  ...
  test('setting a shorthand property, whose shorthands are implicit properties, to an empty string should clear all dependent properties', function () {
    var style = new CSSStyleDeclaration();
    style.borderTopWidth = '1px';
    expect(style.cssText).toEqual('border-top-width: 1px;');
    style.border = '';
  ...
  test('setting border values to "none" should clear dependent values', function () {
    var style = new CSSStyleDeclaration();
    style.borderTopWidth = '1px';
    expect(style.cssText).toEqual('border-top-width: 1px;');
    style.border = 'none';
  ...
  test('setting border to 0 should be okay', function () {
    var style = new CSSStyleDeclaration();
    style.border = 0;
    expect(style.cssText).toEqual('border: 0px;');
  });
  test('setting values implicit and shorthand properties via csstext and setproperty should propagate to dependent properties', function () {
    var style = new CSSStyleDeclaration();
  ...
  test('setting opacity should work', function () {
    var style = new CSSStyleDeclaration();
  ...
  test('width and height of auto should work', function () {
    var style = new CSSStyleDeclaration();
    style.width = 'auto';
  ...
  test('padding and margin should set/clear shorthand properties', function () {
    var style = new CSSStyleDeclaration();
  ...
  test('padding and margin shorthands should set main properties', function () {
    var style = new CSSStyleDeclaration();
    var parts = ['Top', 'Right', 'Bottom', 'Left'];
  ...
  test('setting a value to 0 should return the string value', function () {
    var style = new CSSStyleDeclaration();
    style.setProperty('fill-opacity', 0);
    expect(style.fillOpacity).toEqual('0');
  });
  test('onchange callback should be called when the csstext changes', function () {
    var style = new CSSStyleDeclaration(function (cssText) {
      expect(cssText).toEqual('opacity: 0;');
    });
    style.setProperty('opacity', 0);
  });
  test('setting float should work the same as cssfloat', function () {
    var style = new CSSStyleDeclaration();
    style["float"] = 'left';
    expect(style.cssFloat).toEqual('left');
  });
  test('setting improper css to csstext should not throw', function () {
    var style = new CSSStyleDeclaration();
    style.cssText = 'color: ';
    expect(style.cssText).toEqual('');
    style.color = 'black';
  ...
  test('url parsing works with quotes', function () {
    var style = new CSSStyleDeclaration();
  ...
  test('setting 0 to a padding or margin works', function () {
    var style = new CSSStyleDeclaration();
    style.padding = 0;
  ...
  test('setting ex units to a padding or margin works', function () {
    var style = new CSSStyleDeclaration();
    style.padding = '1ex';
  ...
  test('setting null to background works', function () {
    var style = new CSSStyleDeclaration();
  ...
  test('flex properties should keep their values', function () {
    var style = new CSSStyleDeclaration();
  ...
  test('shorthand flex works', function () {
    var style = new CSSStyleDeclaration();
  ...
  test('font-size get a valid value', function () {
    var style = new CSSStyleDeclaration();
    var invalidValue = '1r5px';
    style.cssText = 'font-size: 15px';
    expect(1).toEqual(style.length);
    style.cssText = "font-size: ".concat(invalidValue);
    expect(0).toEqual(style.length);
    expect(undefined).toEqual(style[0]);
  });
  test('getPropertyValue for custom properties in cssText', function () {
    var style = new CSSStyleDeclaration();
    style.cssText = '--foo: red';
    expect(style.getPropertyValue('--foo')).toEqual('red');
  });
  test('getPropertyValue for custom properties with setProperty', function () {
    var style = new CSSStyleDeclaration();
    style.setProperty('--bar', 'blue');
    expect(style.getPropertyValue('--bar')).toEqual('blue');
  });
  test('getPropertyValue for custom properties with object setter', function () {
    var style = new CSSStyleDeclaration();
    style['--baz'] = 'yellow';
    expect(style.getPropertyValue('--baz')).toEqual('');
  });
  test('custom properties are case-sensitive', function () {
    var style = new CSSStyleDeclaration();
    style.cssText = '--fOo: purple';
    expect(style.getPropertyValue('--foo')).toEqual('');
    expect(style.getPropertyValue('--fOo')).toEqual('purple');
  });
  test('supports calc', function () {
    var style = new CSSStyleDeclaration();
