'use strict'; // autogenerated - 4/29/2020
...
function fontSize_local_fn_parse(v) {
  var valueAsString = String(v).toLowerCase();
  var optionalArguments = fontSize_local_var_absoluteSizes.concat(fontSize_local_var_relativeSizes);
  var isOptionalArgument = optionalArguments.some(function (stringValue) {
    return stringValue.toLowerCase() === valueAsString;
  });
...
font_export_definition = {
  set: function set(v) {
    var _short = external_dependency_parsers_0.shorthandParser(v, font_local_var_shorthand_for);
