...
var printPatternCaret = function printPatternCaret(pattern, pipe) {
...
var printRestoredPatternCaret = function printRestoredPatternCaret(pattern, currentUsageRows, pipe) {
  var inputText = "".concat(_chalk()["default"].dim(" pattern \u203A"), " ").concat(pattern);
