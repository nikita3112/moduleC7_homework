...
URLStateMachine.prototype["parse query"] = function parseQuery(c) {
  ...
  if (!this.stateOverride & c === 35) {
    ...
    var queryPercentEncodePredicate = isSpecial(this.url) ? isSpecialQueryPercentEncode : isQueryPercentEncode; // TODO: use "percent-encode after encoding" passing in this.encodingOverride
