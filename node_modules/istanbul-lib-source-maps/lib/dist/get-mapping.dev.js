...
function originalEndPositionFor(sourceMap, generatedEnd) {
  ...
  var beforeEndMapping = originalPositionTryBoth(sourceMap, generatedEnd.line, generatedEnd.column - 1);
...
function originalPositionTryBoth(sourceMap, line, column) {
  var mapping = sourceMap.originalPositionFor({
    line: line,
    column: column,
...
function getMapping(sourceMap, generatedLocation, origFile) {
  ...
  var start = originalPositionTryBoth(sourceMap, generatedLocation.start.line, generatedLocation.start.column);
  var end = originalEndPositionFor(sourceMap, generatedLocation.end);
