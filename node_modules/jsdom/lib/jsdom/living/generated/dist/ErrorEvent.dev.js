...
var ErrorEventInit = require("./ErrorEventInit.js");
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["ErrorEvent"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$Event) {
    _inherits(ErrorEvent, _globalObject$Event);
    ...
    function ErrorEvent(type) {
      ...
      }
      {
        ...
        _curArg = ErrorEventInit.convert(_curArg, {
          context: "Failed to construct 'ErrorEvent': parameter 2"
        });
        args.push(_curArg);
      }
      return _possibleConstructorReturn(_this, exports.setup(Object.create((this instanceof ErrorEvent ? this.constructor : void 0).prototype), globalObject, args));
    }
  ...
  Object.defineProperties(ErrorEvent.prototype, _defineProperty({
    message: {
      enumerable: true
    },
    filename: {
...
var Impl = require("../events/ErrorEvent-impl.js");