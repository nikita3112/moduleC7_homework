...
var interfaceName = "HTMLSpanElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLSpanElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLSpanElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLSpanElement, _globalObject$HTMLEle);

    function HTMLSpanElement() {
      var _this;

      _classCallCheck(this, HTMLSpanElement);

      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLSpanElement ? this.constructor : void 0));
    }

    return HTMLSpanElement;
  }(globalObject.HTMLElement);

  Object.defineProperties(HTMLSpanElement.prototype, _defineProperty({}, Symbol.toStringTag, {
...
var Impl = require("../nodes/HTMLSpanElement-impl.js");