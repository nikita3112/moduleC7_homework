...
var interfaceName = "HTMLTitleElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLTitleElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLTitleElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLTitleElement, _globalObject$HTMLEle);

    function HTMLTitleElement() {
      var _this;

      _classCallCheck(this, HTMLTitleElement);

      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLTitleElement ? this.constructor : void 0));
    }

    _createClass(HTMLTitleElement, [{
      key: "text",
      get: function get() {
  ...
  Object.defineProperties(HTMLTitleElement.prototype, _defineProperty({
    text: {
      enumerable: true
    }
  }, Symbol.toStringTag, {
...
var Impl = require("../nodes/HTMLTitleElement-impl.js");