...
var interfaceName = "HTMLParagraphElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLParagraphElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLParagraphElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLParagraphElement, _globalObject$HTMLEle);

    function HTMLParagraphElement() {
      var _this;

      _classCallCheck(this, HTMLParagraphElement);

      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLParagraphElement ? this.constructor : void 0));
    }

    _createClass(HTMLParagraphElement, [{
      key: "align",
      get: function get() {
  ...
  Object.defineProperties(HTMLParagraphElement.prototype, _defineProperty({
    align: {
      enumerable: true
    }
  }, Symbol.toStringTag, {
...
var Impl = require("../nodes/HTMLParagraphElement-impl.js");