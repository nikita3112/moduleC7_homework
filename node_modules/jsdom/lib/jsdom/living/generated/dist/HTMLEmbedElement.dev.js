...
var interfaceName = "HTMLEmbedElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLEmbedElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLEmbedElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLEmbedElement, _globalObject$HTMLEle);
    ...
    function HTMLEmbedElement() {
      ...
      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLEmbedElement ? this.constructor : void 0));
    }

    _createClass(HTMLEmbedElement, [{
      key: "src",
      get: function get() {
  ...
  Object.defineProperties(HTMLEmbedElement.prototype, _defineProperty({
    src: {
      enumerable: true
    },
    type: {
...
var Impl = require("../nodes/HTMLEmbedElement-impl.js");