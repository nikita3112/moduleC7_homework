...
var interfaceName = "HTMLHeadingElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLHeadingElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLHeadingElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLHeadingElement, _globalObject$HTMLEle);

    function HTMLHeadingElement() {
      var _this;

      _classCallCheck(this, HTMLHeadingElement);

      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLHeadingElement ? this.constructor : void 0));
    }

    _createClass(HTMLHeadingElement, [{
      key: "align",
      get: function get() {
  ...
  Object.defineProperties(HTMLHeadingElement.prototype, _defineProperty({
    align: {
      enumerable: true
    }
  }, Symbol.toStringTag, {
...
var Impl = require("../nodes/HTMLHeadingElement-impl.js");