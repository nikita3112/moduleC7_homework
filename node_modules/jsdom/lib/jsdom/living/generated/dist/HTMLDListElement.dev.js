...
var interfaceName = "HTMLDListElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLDListElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLDListElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLDListElement, _globalObject$HTMLEle);

    function HTMLDListElement() {
      var _this;

      _classCallCheck(this, HTMLDListElement);

      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLDListElement ? this.constructor : void 0));
    }

    _createClass(HTMLDListElement, [{
      key: "compact",
      get: function get() {
  ...
  Object.defineProperties(HTMLDListElement.prototype, _defineProperty({
    compact: {
      enumerable: true
    }
  }, Symbol.toStringTag, {
...
var Impl = require("../nodes/HTMLDListElement-impl.js");