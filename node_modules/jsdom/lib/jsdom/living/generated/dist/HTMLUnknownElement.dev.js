...
var interfaceName = "HTMLUnknownElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLUnknownElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLUnknownElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLUnknownElement, _globalObject$HTMLEle);

    function HTMLUnknownElement() {
      var _this;

      _classCallCheck(this, HTMLUnknownElement);
  ...
  Object.defineProperties(HTMLUnknownElement.prototype, _defineProperty({}, Symbol.toStringTag, {
...
var Impl = require("../nodes/HTMLUnknownElement-impl.js");