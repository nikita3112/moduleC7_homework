...
var interfaceName = "HTMLDirectoryElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLDirectoryElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLDirectoryElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLDirectoryElement, _globalObject$HTMLEle);

    function HTMLDirectoryElement() {
      var _this;

      _classCallCheck(this, HTMLDirectoryElement);

      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLDirectoryElement ? this.constructor : void 0));
    }

    _createClass(HTMLDirectoryElement, [{
      key: "compact",
      get: function get() {
  ...
  Object.defineProperties(HTMLDirectoryElement.prototype, _defineProperty({
    compact: {
      enumerable: true
    }
  }, Symbol.toStringTag, {
...
var Impl = require("../nodes/HTMLDirectoryElement-impl.js");