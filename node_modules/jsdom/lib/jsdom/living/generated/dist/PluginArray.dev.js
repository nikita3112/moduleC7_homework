...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'PluginArray'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["PluginArray"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function () {
    ...
    _createClass(PluginArray, [{
      ...
      value: function refresh() {
        ...
        return (_esValue$implSymbol = esValue[implSymbol]).refresh.apply(_esValue$implSymbol, args);
      }
    }, {
      key: "item",
      value: function item(index) {
        ...
        if (arguments.length < 1) {
          throw new TypeError("Failed to execute 'item' on 'PluginArray': 1 argument required, but only " + arguments.length + " present.");
        }
        ...
        return utils.tryWrapperForImpl((_esValue$implSymbol2 = esValue[implSymbol]).item.apply(_esValue$implSymbol2, args));
      }
    }, {
      key: "namedItem",
      value: function namedItem(name) {
        ...
        if (arguments.length < 1) {
          throw new TypeError("Failed to execute 'namedItem' on 'PluginArray': 1 argument required, but only " + arguments.length + " present.");
        }
        ...
        return utils.tryWrapperForImpl((_esValue$implSymbol3 = esValue[implSymbol]).namedItem.apply(_esValue$implSymbol3, args));
      }
    }, {
      key: "length",
      get: function get() {
  ...
  Object.defineProperties(PluginArray.prototype, (_Object$definePropert = {
    refresh: {
      enumerable: true
    },
    item: {
...
var proxyHandler = {
  ...
  ownKeys: function ownKeys(target) {
    ...
    try {
      for (var _iterator2 = target[implSymbol][utils.supportedPropertyNames][Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    try {
      for (var _iterator3 = Reflect.ownKeys(target)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
  ...
  getOwnPropertyDescriptor: function getOwnPropertyDescriptor(target, P) {
    ...
    var namedValue = target[implSymbol].namedItem(P);
  ...
  defineProperty: function defineProperty(target, P, desc) {
    ...
    if (!utils.hasOwn(target, P)) {
      var creating = !(target[implSymbol].namedItem(P) !== null);
...
var Impl = require("../navigator/PluginArray-impl.js");