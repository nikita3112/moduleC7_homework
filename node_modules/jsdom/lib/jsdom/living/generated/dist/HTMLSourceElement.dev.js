...
var interfaceName = "HTMLSourceElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLSourceElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLSourceElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLSourceElement, _globalObject$HTMLEle);
    ...
    function HTMLSourceElement() {
      ...
      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLSourceElement ? this.constructor : void 0));
    }

    _createClass(HTMLSourceElement, [{
      key: "src",
      get: function get() {
      ...
      get: function get() {
        ...
        try {
          var value = esValue[implSymbol].getAttributeNS(null, "srcset");
      ...
      get: function get() {
        ...
        try {
          var value = esValue[implSymbol].getAttributeNS(null, "sizes");
          return value === null ? "" : value;
        } finally {
          ceReactionsPostSteps_helpers_custom_elements(globalObject);
        }
  ...
  Object.defineProperties(HTMLSourceElement.prototype, _defineProperty({
    src: {
      enumerable: true
    },
    type: {
...
var Impl = require("../nodes/HTMLSourceElement-impl.js");