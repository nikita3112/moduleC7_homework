...
var interfaceName = "HTMLLIElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLLIElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLLIElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLLIElement, _globalObject$HTMLEle);

    function HTMLLIElement() {
      var _this;

      _classCallCheck(this, HTMLLIElement);

      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLLIElement ? this.constructor : void 0));
    }

    _createClass(HTMLLIElement, [{
      key: "value",
      get: function get() {
  ...
  Object.defineProperties(HTMLLIElement.prototype, _defineProperty({
    value: {
      enumerable: true
    },
    type: {
...
var Impl = require("../nodes/HTMLLIElement-impl.js");