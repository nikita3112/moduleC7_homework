...
var FocusEventInit = require("./FocusEventInit.js");
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'FocusEvent'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["FocusEvent"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$UIEvent) {
    _inherits(FocusEvent, _globalObject$UIEvent);
    ...
    function FocusEvent(type) {
      ...
      }
      {
        ...
        _curArg = FocusEventInit.convert(_curArg, {
          context: "Failed to construct 'FocusEvent': parameter 2"
        });
        args.push(_curArg);
      }
      return _possibleConstructorReturn(_this, exports.setup(Object.create((this instanceof FocusEvent ? this.constructor : void 0).prototype), globalObject, args));
    }
  ...
  Object.defineProperties(FocusEvent.prototype, _defineProperty({
    relatedTarget: {
      enumerable: true
    }
  }, Symbol.toStringTag, {
...
var Impl = require("../events/FocusEvent-impl.js");