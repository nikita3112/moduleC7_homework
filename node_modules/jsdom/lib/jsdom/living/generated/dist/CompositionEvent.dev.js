...
var CompositionEventInit = require("./CompositionEventInit.js");
...
var interfaceName = "CompositionEvent";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'CompositionEvent'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["CompositionEvent"];
...
exports.install = function (globalObject, globalNames) {
  ...
  /*#__PURE__*/
  function (_globalObject$UIEvent) {
    _inherits(CompositionEvent, _globalObject$UIEvent);
    ...
    function CompositionEvent(type) {
      ...
      if (arguments.length < 1) {
        throw new TypeError("Failed to construct 'CompositionEvent': 1 argument required, but only " + arguments.length + " present.");
      }
      ...
      }
      {
        ...
        _curArg = CompositionEventInit.convert(_curArg, {
          context: "Failed to construct 'CompositionEvent': parameter 2"
        });
        args.push(_curArg);
      }
      return _possibleConstructorReturn(_this, exports.setup(Object.create((this instanceof CompositionEvent ? this.constructor : void 0).prototype), globalObject, args));
    }

    _createClass(CompositionEvent, [{
      key: "initCompositionEvent",
      value: function initCompositionEvent(typeArg) {
        ...
        if (arguments.length < 1) {
          throw new TypeError("Failed to execute 'initCompositionEvent' on 'CompositionEvent': 1 argument required, but only " + arguments.length + " present.");
        }
        ...
        return (_esValue$implSymbol = esValue[implSymbol]).initCompositionEvent.apply(_esValue$implSymbol, args);
      }
    }, {
      key: "data",
      get: function get() {
  ...
  Object.defineProperties(CompositionEvent.prototype, _defineProperty({
...
var Impl = require("../events/CompositionEvent-impl.js");