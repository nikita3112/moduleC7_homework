...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLButtonElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLButtonElement, _globalObject$HTMLEle);
    ...
    function HTMLButtonElement() {
      ...
      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLButtonElement ? this.constructor : void 0));
    }
    ...
    _createClass(HTMLButtonElement, [{
      ...
      get: function get() {
        ...
        try {
          var value = esValue[implSymbol].getAttributeNS(null, "formtarget");
