...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'BarProp'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["BarProp"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function () {
    function BarProp() {
      _classCallCheck(this, BarProp);

      throw new TypeError("Illegal constructor");
    }

    _createClass(BarProp, [{
      key: "visible",
      get: function get() {
  ...
  Object.defineProperties(BarProp.prototype, _defineProperty({
    visible: {
      enumerable: true
    }
  }, Symbol.toStringTag, {
...
var Impl = require("../window/BarProp-impl.js");