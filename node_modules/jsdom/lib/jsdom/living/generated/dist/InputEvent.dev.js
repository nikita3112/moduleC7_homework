...
var InputEventInit = require("./InputEventInit.js");
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'InputEvent'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["InputEvent"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$UIEvent) {
    _inherits(InputEvent, _globalObject$UIEvent);
    ...
    function InputEvent(type) {
      ...
      }
      {
        ...
        _curArg = InputEventInit.convert(_curArg, {
          context: "Failed to construct 'InputEvent': parameter 2"
        });
        args.push(_curArg);
      }
      return _possibleConstructorReturn(_this, exports.setup(Object.create((this instanceof InputEvent ? this.constructor : void 0).prototype), globalObject, args));
    }
  ...
  Object.defineProperties(InputEvent.prototype, _defineProperty({
    data: {
      enumerable: true
    },
    isComposing: {
...
var Impl = require("../events/InputEvent-impl.js");