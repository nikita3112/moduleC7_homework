...
var interfaceName = "HTMLTemplateElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLTemplateElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLTemplateElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLTemplateElement, _globalObject$HTMLEle);

    function HTMLTemplateElement() {
      var _this;

      _classCallCheck(this, HTMLTemplateElement);

      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLTemplateElement ? this.constructor : void 0));
    }

    _createClass(HTMLTemplateElement, [{
      key: "content",
      get: function get() {
  ...
  Object.defineProperties(HTMLTemplateElement.prototype, _defineProperty({
    content: {
      enumerable: true
    }
  }, Symbol.toStringTag, {
...
var Impl = require("../nodes/HTMLTemplateElement-impl.js");