...
var interfaceName = "HTMLParamElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLParamElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLParamElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLParamElement, _globalObject$HTMLEle);

    function HTMLParamElement() {
      var _this;

      _classCallCheck(this, HTMLParamElement);

      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLParamElement ? this.constructor : void 0));
    }

    _createClass(HTMLParamElement, [{
      key: "name",
      get: function get() {
      ...
      get: function get() {
        ...
        try {
          var value = esValue[implSymbol].getAttributeNS(null, "value");
          return value === null ? "" : value;
        } finally {
          ceReactionsPostSteps_helpers_custom_elements(globalObject);
        }
      ...
      get: function get() {
        ...
        try {
          var value = esValue[implSymbol].getAttributeNS(null, "valuetype");
          return value === null ? "" : value;
        } finally {
          ceReactionsPostSteps_helpers_custom_elements(globalObject);
        }
  ...
  Object.defineProperties(HTMLParamElement.prototype, _defineProperty({
    name: {
      enumerable: true
    },
    value: {
...
var Impl = require("../nodes/HTMLParamElement-impl.js");