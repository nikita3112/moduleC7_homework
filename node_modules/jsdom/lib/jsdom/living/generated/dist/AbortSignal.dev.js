...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'AbortSignal'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["AbortSignal"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$EventTa) {
    _inherits(AbortSignal, _globalObject$EventTa);
  ...
  Object.defineProperties(AbortSignal.prototype, _defineProperty({
    aborted: {
      enumerable: true
    },
    onabort: {
...
var Impl = require("../aborting/AbortSignal-impl.js");