...
var interfaceName = "HTMLOutputElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLOutputElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLOutputElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLOutputElement, _globalObject$HTMLEle);

    function HTMLOutputElement() {
      var _this;

      _classCallCheck(this, HTMLOutputElement);

      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLOutputElement ? this.constructor : void 0));
    }

    _createClass(HTMLOutputElement, [{
      key: "checkValidity",
      ...
      get: function get() {
        ...
        return utils.getSameObject(this, "htmlFor", function () {
  ...
  Object.defineProperties(HTMLOutputElement.prototype, _defineProperty({
    checkValidity: {
      enumerable: true
    },
    reportValidity: {
...
var Impl = require("../nodes/HTMLOutputElement-impl.js");