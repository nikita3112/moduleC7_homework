...
var PopStateEventInit = require("./PopStateEventInit.js");
...
var interfaceName = "PopStateEvent";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'PopStateEvent'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["PopStateEvent"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$Event) {
    _inherits(PopStateEvent, _globalObject$Event);

    function PopStateEvent(type) {
      var _this;

      _classCallCheck(this, PopStateEvent);
      ...
      }
      {
        ...
        _curArg = PopStateEventInit.convert(_curArg, {
          context: "Failed to construct 'PopStateEvent': parameter 2"
        });
        args.push(_curArg);
      }
      return _possibleConstructorReturn(_this, exports.setup(Object.create((this instanceof PopStateEvent ? this.constructor : void 0).prototype), globalObject, args));
    }

    _createClass(PopStateEvent, [{
      key: "state",
      get: function get() {
  ...
  Object.defineProperties(PopStateEvent.prototype, _defineProperty({
    state: {
      enumerable: true
    }
  }, Symbol.toStringTag, {
...
var Impl = require("../events/PopStateEvent-impl.js");