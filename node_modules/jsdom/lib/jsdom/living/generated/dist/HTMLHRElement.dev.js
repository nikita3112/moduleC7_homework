...
var interfaceName = "HTMLHRElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLHRElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLHRElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLHRElement, _globalObject$HTMLEle);

    function HTMLHRElement() {
      var _this;

      _classCallCheck(this, HTMLHRElement);

      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLHRElement ? this.constructor : void 0));
    }

    _createClass(HTMLHRElement, [{
      key: "align",
      get: function get() {
  ...
  Object.defineProperties(HTMLHRElement.prototype, _defineProperty({
    align: {
      enumerable: true
    },
    color: {
...
var Impl = require("../nodes/HTMLHRElement-impl.js");