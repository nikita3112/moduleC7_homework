...
var AssignedNodesOptions = require("./AssignedNodesOptions.js");
...
var interfaceName = "HTMLSlotElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLSlotElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLSlotElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLSlotElement, _globalObject$HTMLEle);
    ...
    function HTMLSlotElement() {
      ...
      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLSlotElement ? this.constructor : void 0));
    }

    _createClass(HTMLSlotElement, [{
      key: "assignedNodes",
      value: function assignedNodes() {
        ...
        return utils.tryWrapperForImpl((_esValue$implSymbol = esValue[implSymbol]).assignedNodes.apply(_esValue$implSymbol, args));
      }
    }, {
      ...
      value: function assignedElements() {
        ...
        return utils.tryWrapperForImpl((_esValue$implSymbol2 = esValue[implSymbol]).assignedElements.apply(_esValue$implSymbol2, args));
      }
    }, {
      key: "name",
      get: function get() {
  ...
  Object.defineProperties(HTMLSlotElement.prototype, _defineProperty({
    assignedNodes: {
      enumerable: true
    },
    assignedElements: {
...
var Impl = require("../nodes/HTMLSlotElement-impl.js");