...
var interfaceName = "HTMLModElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLModElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLModElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLModElement, _globalObject$HTMLEle);
    ...
    function HTMLModElement() {
      ...
      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLModElement ? this.constructor : void 0));
    }

    _createClass(HTMLModElement, [{
      key: "cite",
      get: function get() {
        ...
        try {
          var value = esValue[implSymbol].getAttributeNS(null, "cite");
      ...
      get: function get() {
        ...
        try {
          var value = esValue[implSymbol].getAttributeNS(null, "datetime");
  ...
  Object.defineProperties(HTMLModElement.prototype, _defineProperty({
    cite: {
      enumerable: true
    },
    dateTime: {
...
var Impl = require("../nodes/HTMLModElement-impl.js");