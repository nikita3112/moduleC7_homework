...
var interfaceName = "SVGTitleElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'SVGTitleElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["SVGTitleElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$SVGElem) {
    _inherits(SVGTitleElement, _globalObject$SVGElem);

    function SVGTitleElement() {
      var _this;

      _classCallCheck(this, SVGTitleElement);
  ...
  Object.defineProperties(SVGTitleElement.prototype, _defineProperty({}, Symbol.toStringTag, {
...
var Impl = require("../nodes/SVGTitleElement-impl.js");