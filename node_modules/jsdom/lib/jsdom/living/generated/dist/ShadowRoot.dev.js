...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'ShadowRoot'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["ShadowRoot"];
...
exports.install = function (globalObject, globalNames) {
  ...
  var ShadowRoot =
  /*#__PURE__*/
  function (_globalObject$Documen) {
    _inherits(ShadowRoot, _globalObject$Documen);
    ...
    return ShadowRoot;
  }(globalObject.DocumentFragment);

  Object.defineProperties(ShadowRoot.prototype, _defineProperty({
    mode: {
      enumerable: true
    },
    host: {
...
var Impl = require("../nodes/ShadowRoot-impl.js");