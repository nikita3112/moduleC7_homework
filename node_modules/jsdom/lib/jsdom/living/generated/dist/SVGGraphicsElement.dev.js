...
var interfaceName = "SVGGraphicsElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'SVGGraphicsElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["SVGGraphicsElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  /*#__PURE__*/
  function (_globalObject$SVGElem) {
    _inherits(SVGGraphicsElement, _globalObject$SVGElem);

    function SVGGraphicsElement() {
      var _this;

      _classCallCheck(this, SVGGraphicsElement);

      throw new TypeError("Illegal constructor");
      return _possibleConstructorReturn(_this);
    }

    _createClass(SVGGraphicsElement, [{
      ...
      get: function get() {
        ...
        return utils.getSameObject(this, "requiredExtensions", function () {
      ...
      get: function get() {
        ...
        return utils.getSameObject(this, "systemLanguage", function () {
  ...
  }(globalObject.SVGElement);

  Object.defineProperties(SVGGraphicsElement.prototype, _defineProperty({
    requiredExtensions: {
      enumerable: true
    },
    systemLanguage: {
...
var Impl = require("../nodes/SVGGraphicsElement-impl.js");