...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLBaseElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLBaseElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLBaseElement, _globalObject$HTMLEle);

    function HTMLBaseElement() {
      var _this;

      _classCallCheck(this, HTMLBaseElement);

      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLBaseElement ? this.constructor : void 0));
    }

    _createClass(HTMLBaseElement, [{
      key: "href",
      get: function get() {
  ...
  Object.defineProperties(HTMLBaseElement.prototype, _defineProperty({
    href: {
      enumerable: true
    },
    target: {
...
var Impl = require("../nodes/HTMLBaseElement-impl.js");