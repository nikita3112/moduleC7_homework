...
var StaticRangeInit = require("./StaticRangeInit.js");
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'StaticRange'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["StaticRange"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$Abstrac) {
    _inherits(StaticRange, _globalObject$Abstrac);

    function StaticRange(init) {
      var _this;

      _classCallCheck(this, StaticRange);

      if (arguments.length < 1) {
        throw new TypeError("Failed to construct 'StaticRange': 1 argument required, but only " + arguments.length + " present.");
      }

      var args = [];
      {
        var curArg = arguments[0];
        curArg = StaticRangeInit.convert(curArg, {
          context: "Failed to construct 'StaticRange': parameter 1"
        });
        args.push(curArg);
      }
      return _possibleConstructorReturn(_this, exports.setup(Object.create((this instanceof StaticRange ? this.constructor : void 0).prototype), globalObject, args));
    }

    return StaticRange;
  }(globalObject.AbstractRange);

  Object.defineProperties(StaticRange.prototype, _defineProperty({}, Symbol.toStringTag, {
    value: "StaticRange",
    configurable: true
  }));
...
var Impl = require("../range/StaticRange-impl.js");