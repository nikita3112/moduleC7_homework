...
var interfaceName = "HTMLDialogElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLDialogElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLDialogElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLDialogElement, _globalObject$HTMLEle);

    function HTMLDialogElement() {
      var _this;

      _classCallCheck(this, HTMLDialogElement);

      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLDialogElement ? this.constructor : void 0));
    }

    _createClass(HTMLDialogElement, [{
      key: "open",
      get: function get() {
  ...
  Object.defineProperties(HTMLDialogElement.prototype, _defineProperty({
    open: {
      enumerable: true
    }
  }, Symbol.toStringTag, {
...
var Impl = require("../nodes/HTMLDialogElement-impl.js");