...
var interfaceName = "HTMLTableCaptionElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLTableCaptionElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLTableCaptionElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLTableCaptionElement, _globalObject$HTMLEle);

    function HTMLTableCaptionElement() {
      var _this;

      _classCallCheck(this, HTMLTableCaptionElement);

      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLTableCaptionElement ? this.constructor : void 0));
    }

    _createClass(HTMLTableCaptionElement, [{
      key: "align",
      get: function get() {
  ...
  Object.defineProperties(HTMLTableCaptionElement.prototype, _defineProperty({
    align: {
      enumerable: true
    }
  }, Symbol.toStringTag, {
...
var Impl = require("../nodes/HTMLTableCaptionElement-impl.js");