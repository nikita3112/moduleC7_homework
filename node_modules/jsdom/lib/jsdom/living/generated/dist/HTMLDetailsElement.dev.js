...
var interfaceName = "HTMLDetailsElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLDetailsElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLDetailsElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLDetailsElement, _globalObject$HTMLEle);

    function HTMLDetailsElement() {
      var _this;

      _classCallCheck(this, HTMLDetailsElement);

      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLDetailsElement ? this.constructor : void 0));
    }

    _createClass(HTMLDetailsElement, [{
      key: "open",
      get: function get() {
  ...
  Object.defineProperties(HTMLDetailsElement.prototype, _defineProperty({
    open: {
      enumerable: true
    }
  }, Symbol.toStringTag, {
...
var Impl = require("../nodes/HTMLDetailsElement-impl.js");