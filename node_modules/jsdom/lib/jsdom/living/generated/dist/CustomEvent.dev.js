...
var CustomEventInit = require("./CustomEventInit.js");
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'CustomEvent'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["CustomEvent"];
...
exports.install = function (globalObject, globalNames) {
  ...
  var CustomEvent =
  /*#__PURE__*/
  function (_globalObject$Event) {
    _inherits(CustomEvent, _globalObject$Event);
    ...
    function CustomEvent(type) {
      ...
      }
      {
        ...
        _curArg = CustomEventInit.convert(_curArg, {
          context: "Failed to construct 'CustomEvent': parameter 2"
        });
        args.push(_curArg);
      }
      return _possibleConstructorReturn(_this, exports.setup(Object.create((this instanceof CustomEvent ? this.constructor : void 0).prototype), globalObject, args));
    }

    _createClass(CustomEvent, [{
      key: "initCustomEvent",
      value: function initCustomEvent(type) {
        ...
        return (_esValue$implSymbol = esValue[implSymbol]).initCustomEvent.apply(_esValue$implSymbol, args);
      }
    }, {
      key: "detail",
      get: function get() {
  ...
  Object.defineProperties(CustomEvent.prototype, _defineProperty({
    initCustomEvent: {
      enumerable: true
    },
    detail: {
...
var Impl = require("../events/CustomEvent-impl.js");