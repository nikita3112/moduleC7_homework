...
var interfaceName = "HTMLPictureElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLPictureElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLPictureElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLPictureElement, _globalObject$HTMLEle);

    function HTMLPictureElement() {
      var _this;

      _classCallCheck(this, HTMLPictureElement);

      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLPictureElement ? this.constructor : void 0));
    }

    return HTMLPictureElement;
  }(globalObject.HTMLElement);

  Object.defineProperties(HTMLPictureElement.prototype, _defineProperty({}, Symbol.toStringTag, {
...
var Impl = require("../nodes/HTMLPictureElement-impl.js");