...
var interfaceName = "HTMLFrameElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLFrameElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLFrameElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLFrameElement, _globalObject$HTMLEle);

    function HTMLFrameElement() {
      var _this;

      _classCallCheck(this, HTMLFrameElement);

      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLFrameElement ? this.constructor : void 0));
    }

    _createClass(HTMLFrameElement, [{
      key: "name",
      get: function get() {
  ...
  Object.defineProperties(HTMLFrameElement.prototype, _defineProperty({
    name: {
      enumerable: true
    },
    scrolling: {
...
var Impl = require("../nodes/HTMLFrameElement-impl.js");