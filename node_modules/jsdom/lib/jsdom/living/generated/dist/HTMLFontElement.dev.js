...
var interfaceName = "HTMLFontElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLFontElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLFontElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLFontElement, _globalObject$HTMLEle);

    function HTMLFontElement() {
      var _this;

      _classCallCheck(this, HTMLFontElement);

      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLFontElement ? this.constructor : void 0));
    }

    _createClass(HTMLFontElement, [{
      key: "color",
      get: function get() {
        ...
        try {
          var value = esValue[implSymbol].getAttributeNS(null, "color");
      ...
      get: function get() {
        ...
        try {
          var value = esValue[implSymbol].getAttributeNS(null, "face");
          return value === null ? "" : value;
        } finally {
          ceReactionsPostSteps_helpers_custom_elements(globalObject);
        }
  ...
  Object.defineProperties(HTMLFontElement.prototype, _defineProperty({
    color: {
      enumerable: true
    },
    face: {
...
var Impl = require("../nodes/HTMLFontElement-impl.js");