...
var interfaceName = "SVGAnimatedString";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'SVGAnimatedString'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["SVGAnimatedString"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function () {
    function SVGAnimatedString() {
      _classCallCheck(this, SVGAnimatedString);

      throw new TypeError("Illegal constructor");
    }

    _createClass(SVGAnimatedString, [{
      key: "baseVal",
      get: function get() {
  ...
  Object.defineProperties(SVGAnimatedString.prototype, _defineProperty({
    baseVal: {
      enumerable: true
    },
    animVal: {
...
var Impl = require("../svg/SVGAnimatedString-impl.js");