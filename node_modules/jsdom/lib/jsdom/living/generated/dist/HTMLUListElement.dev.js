...
var interfaceName = "HTMLUListElement";
...
exports.convert = function (value) {
  ...
  throw new TypeError("".concat(context, " is not of type 'HTMLUListElement'."));
};
...
function makeWrapper(globalObject) {
  ...
  var ctor = globalObject[ctorRegistrySymbol]["HTMLUListElement"];
...
exports.install = function (globalObject, globalNames) {
  ...
  function (_globalObject$HTMLEle) {
    _inherits(HTMLUListElement, _globalObject$HTMLEle);

    function HTMLUListElement() {
      var _this;

      _classCallCheck(this, HTMLUListElement);

      return _possibleConstructorReturn(_this, HTMLConstructor_helpers_html_constructor(globalObject, interfaceName, this instanceof HTMLUListElement ? this.constructor : void 0));
    }

    _createClass(HTMLUListElement, [{
      key: "compact",
      get: function get() {
  ...
  Object.defineProperties(HTMLUListElement.prototype, _defineProperty({
    compact: {
      enumerable: true
    },
    type: {
...
var Impl = require("../nodes/HTMLUListElement-impl.js");