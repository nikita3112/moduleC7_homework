...
var HTMLFrameSetElementImpl =
/*#__PURE__*/
function (_HTMLElementImpl) {
  _inherits(HTMLFrameSetElementImpl, _HTMLElementImpl);
  ...
  function HTMLFrameSetElementImpl() {
    ...
    _classCallCheck(this, HTMLFrameSetElementImpl);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(HTMLFrameSetElementImpl)).call.apply(_getPrototypeOf2, [this].concat(args)));
