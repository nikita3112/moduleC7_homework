...
function (_HTMLElementImpl) {
  ...
  function HTMLDetailsElementImpl(globalObject, args, privateData) {
    var _this;

    _classCallCheck(this, HTMLDetailsElementImpl);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(HTMLDetailsElementImpl).call(this, globalObject, args, privateData));
