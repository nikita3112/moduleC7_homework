...
var xpath = require("../level3/xpath"); // This object defines the mapping between the interface name and the generated interface wrapper code.
...
exports.installInterfaces = function (window, globalNames) {
  // Install generated interface.
  for (var _i = 0, _Object$values = Object.values(generatedInterfaces); _i < _Object$values.length; _i++) {
    var generatedInterface = _Object$values[_i];
