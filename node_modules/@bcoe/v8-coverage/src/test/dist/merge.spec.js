...
describe("merge", function () {
    ...
    describe("benches", function () {
        var _loop_3 = function (bench) {
            ...
            var name = path_1["default"].basename(bench);
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 2:
                                inputs = _a.sent();
                                expectedPath = path_1["default"].join(BENCHES_DIR, name + ".json");
...
function getSourceFiles() {
    ...
    function getSourcesFrom(dir) {
        var names, _i, names_1, name, resolved, stat;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    name = names_1[_i];
                    resolved = path_1["default"].join(dir, name);
...
function getBenches() {
    var names, _i, names_2, name, resolved, stat;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                ...
                name = names_2[_i];
                resolved = path_1["default"].join(BENCHES_INPUT_DIR, name);
                stat = fs_1["default"].statSync(resolved);
                if (!stat.isDirectory()) return [3 /*break*/, 3];
