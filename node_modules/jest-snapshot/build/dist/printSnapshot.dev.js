...
var printExpected = function printExpected(val) {
  return (0, _jestMatcherUtils.EXPECTED_COLOR)((0, _utils2.minify)(val));
};

exports.printExpected = printExpected;

var printReceived = function printReceived(val) {
  return (0, _jestMatcherUtils.RECEIVED_COLOR)((0, _utils2.minify)(val));
};

exports.printReceived = printReceived;

var printPropertiesAndReceived = function printPropertiesAndReceived(properties, received, expand) {
...
var printSnapshotAndReceived = function printSnapshotAndReceived(a, b, received, expand) {
  ...
  if (typeof received === 'string') {
    if (a.length >= 2 && a.startsWith('"') && a.endsWith('"') && b === (0, _prettyFormat["default"])(received)) {
      ...
      if (!a.includes('\n') && !b.includes('\n')) {
        ...
        return _printLabel(aAnnotation) + aColor(aQuoted) + '\n' + _printLabel(bAnnotation) + bColor(bQuoted);
  ...
  if (isLineDiffable(received)) {
    ...
    var b0 = (0, _utils2.serialize)(received, 0);
