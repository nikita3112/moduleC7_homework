...
var JsonSummaryReport =
/*#__PURE__*/
function (_ReportBase) {
  _inherits(JsonSummaryReport, _ReportBase);

  function JsonSummaryReport(opts) {
    var _this;

    _classCallCheck(this, JsonSummaryReport);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(JsonSummaryReport).call(this));
    _this.file = opts.file || 'coverage-summary.json';
    _this.contentWriter = null;
    _this.first = true;
    return _this;
  }

  _createClass(JsonSummaryReport, [{
    key: "onStart",
    ...
    key: "writeSummary",
    value: function writeSummary(filePath, sc) {
