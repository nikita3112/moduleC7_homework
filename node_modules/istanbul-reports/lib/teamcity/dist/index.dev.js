...
function (_ReportBase) {
  _inherits(TeamcityReport, _ReportBase);

  function TeamcityReport(opts) {
    var _this;

    _classCallCheck(this, TeamcityReport);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(TeamcityReport).call(this));
    opts = opts || {};
    _this.file = opts.file || null;
    _this.blockName = opts.blockName || 'Code Coverage Summary';
    return _this;
  }

  _createClass(TeamcityReport, [{
    key: "onStart",
