...
InsertionText.prototype = {
  findFirstNonBlank: function findFirstNonBlank() {
    var pos = -1;
    var text = this.text;
    var len = text.length;
    var i;
  ...
  findLastNonBlank: function findLastNonBlank() {
    var text = this.text;
    var len = text.length;
  ...
  originalLength: function originalLength() {
    return this.origLength;
  },
  insertAt: function insertAt(col, str, insertBefore, consumeBlanks) {
  ...
  findOffset: function findOffset(pos, len, insertBefore) {
  ...
  wrap: function wrap(startPos, startText, endPos, endText, consumeBlanks) {
    this.insertAt(startPos, startText, true, consumeBlanks);
    this.insertAt(endPos, endText, false, consumeBlanks);
    return this;
  },
  wrapLine: function wrapLine(startText, endText) {
