...
function (_ReportBase) {
  _inherits(JsonReport, _ReportBase);
  ...
  function JsonReport(opts) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(JsonReport).call(this));
    _this.file = opts.file || 'coverage-final.json';
    _this.first = true;
    return _this;
  }

  _createClass(JsonReport, [{
    key: "onStart",
