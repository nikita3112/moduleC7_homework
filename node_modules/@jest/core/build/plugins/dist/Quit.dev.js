...
function (_jestWatcher$BaseWatc) {
  _inherits(QuitPlugin, _jestWatcher$BaseWatc);

  function QuitPlugin(options) {
    var _this;

    _classCallCheck(this, QuitPlugin);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(QuitPlugin).call(this, options));
