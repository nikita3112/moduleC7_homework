...
function (_jestWatcher$PatternP) {
  ...
  function TestNamePatternPrompt(pipe, prompt) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(TestNamePatternPrompt).call(this, pipe, prompt));

    _defineProperty(_assertThisInitialized(_this), '_cachedTestResults', void 0);
