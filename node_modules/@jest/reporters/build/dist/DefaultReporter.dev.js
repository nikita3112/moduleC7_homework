...
function (_BaseReporter$default) {
  _inherits(DefaultReporter, _BaseReporter$default);
  ...
  _createClass(DefaultReporter, [{
    ...
    value: function printTestFileHeader(_testPath, config, result) {
      ...
      if (result.console) {
        this.log('  ' + TITLE_BULLET + 'Console\n\n' + (0, _console().getConsoleOutput)(config.cwd, !!this._globalConfig.verbose, result.console, config, this._globalConfig));
      }
    }
  }, {
    ...
    value: function printTestFileFailureMessage(_testPath, _config, result) {
      ...
      var snapshotStatuses = (0, _getSnapshotStatus["default"])(result.snapshot, didUpdate);
