...
var VerboseReporter =
/*#__PURE__*/
function (_DefaultReporter$defa) {
  _inherits(VerboseReporter, _DefaultReporter$defa);
  ...
  _createClass(VerboseReporter, [{
    ...
    value: function _logTest(test, indentLevel) {
      ...
      var time = test.duration ? " (".concat((0, _jestUtil().formatTime)(Math.round(test.duration)), ")") : '';
