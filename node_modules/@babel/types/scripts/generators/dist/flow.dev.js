...
try {
  for (var _iterator = t.TYPES[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    var decl = "declare function is".concat(typeName, "(node: ?Object, opts?: ?Object): boolean");
    ...
    lines.push(decl);
    lines.push("declare function assert".concat(typeName, "(node: ?Object, opts?: ?Object): void"));
  }
} catch (err) {
...
lines.push( // assert/
"declare function assertNode(obj: any): void", // builders/
